...
- [x] 3. Backend: Authentication and multi-tenant middleware
  ...
  - [x] 3.4 Write property test for tenant data isolation (Backend)
...
- [x] 5. Backend: Tenant and device management APIs
  ...
  - [x] 5.2 Write property test for tenant credential uniqueness (Backend)
  ...
  - [x] 5.3b Implement device token regeneration endpoint
    - Add `regenerateToken` method to DeviceService that generates a new random token, hashes it, and updates the screen record
    - Create POST `/api/admin/screens/{id}/regenerate-token` endpoint in ScreenController
    - Validate tenant ownership for tenant_admin users
    - Return the new plaintext token in the response (shown once only)
    - Invalidate any existing JWT sessions for the device (the old token hash no longer matches)
...
- [x] 6. Backend: Loop configuration and source toggle APIs
  ...
  - [x] 6.2 Write property test for weight-to-slot assignment (Backend)
  ...
  - [x] 6.4 Write property test for disabled source slot reassignment (Backend)
...
- [x] 7. Backend: Content library and playlist management
  ...
  - [x] 7.2 Write property test for content validation pipeline (Backend)
...
- [x] 8. Backend: Device communication APIs
  ...
  - [x] 8.3 Write property test for heartbeat grace period state machine (Backend)
...
- [x] 11. Player: Local storage layer and configuration
  - [x] 11.1 Implement LocalConfigStore with SQLite schema
  ...
  - [x] 11.2 Implement device authentication client
  ...
  - [x] 11.3 Write property test for credential isolation
  ...
  - [x] 11.4 Write property test for graceful degradation on missing configuration
...
- [x] 12. Player: Content source interface and PlaylistSource
  - [x] 12.1 Define ContentSource interface and PreparedContent types
  ...
  - [x] 12.2 Implement PlaylistSource (local playlist content source)
  ...
  - [x] 12.3 Implement FallbackBuffer with pre-decoded content ready in memory
  ...
  - [x] 12.4 Write property test for fallback buffer invariant
...
- [x] 13. Player: ProDooh and GAM content sources
  - [x] 13.1 Implement ProDoohSource (Prodooh Ad Serving API client)
  ...
  - [x] 13.2 Write property test for rate limit compliance
  ...
  - [x] 13.3 Implement GamVastSource (Google Ad Manager VAST client)
  ...
  - [x] 13.4 Write property test for sandbox tag validation
    - **Property 5: Sandbox Tag Validation**
    - Generate random strings; verify only valid sandbox tag patterns are accepted
    - **Validates: Requirements 3.1**

- [x] 14. Player: URL source and Proof of Play queue
  - [x] 14.1 Implement UrlSource (web content source)
  ...
  - [x] 14.2 Implement POPQueue (Proof of Play persistent queue)
  ...
  - [x] 14.3 Write property test for print ID lifecycle completeness
  ...
  - [x] 14.4 Write property test for exponential backoff calculation
...
- [x] 15. Player: Core loop engine
  - [x] 15.1 Implement LoopEngine (fixed-slot sequential execution)
  ...
  - [x] 15.2 Write property test for loop sequential determinism
  ...
  - [x] 15.3 Write property test for source fallback to playlist local
  ...
  - [x] 15.4 Implement PrefetchManager (background content preparation)
  ...
  - [x] 15.5 Implement slot configuration with source toggle and reassignment
  ...
  - [x] 15.6 Write property test for dynamic loop configuration
...
- [x] 17. Player: Duration resolution and schedule manager
  - [x] 17.1 Implement resolveDuration function (hierarchy-based duration resolution)
  ...
  - [x] 17.2 Write property test for duration resolution hierarchy
  ...
  - [x] 17.3 Implement ScheduleManager (operating hours enforcement)
  ...
  - [x] 17.4 Write property test for schedule evaluation correctness
...
- [x] 18. Player: Sync layer (playlist sync, heartbeat, playback logger)
  - [x] 18.1 Implement PlaylistSyncManager
  ...
  - [x] 18.4 Implement PlaybackLogger (local recording + batch sync)
  ...
  - [x] 18.5 Write property test for playback log completeness
    - **Property 20: Playback Log Completeness**
    - Generate random playback events; verify all required fields are present
    - **Validates: Requirements 18.1**

  - [x] 18.6 Write property test for playback log durability
    - **Property 21: Playback Log Durability**
    - Simulate sync failures; verify no log entries are lost
    - **Validates: Requirements 18.5**

- [x] 19. Player: Display, rendering, and transitions
  - [x] 19.1 Implement FullscreenRenderer with layered display
  ...
  - [x] 19.2 Implement TransitionAnimator (CSS-based transitions)
  ...
  - [x] 19.3 Implement media renderers (Image, Video, Webview)
...
- [x] 20. Player: Storage management and screenshot service
  - [x] 20.1 Implement StorageManager with LRU cleanup
  ...
  - [x] 20.2 Write property test for LRU cleanup safety
  ...
  - [x] 20.3 Implement ScreenshotService
...
- [x] 21. Checkpoint - Player fully functional
...
- [x] 22. Player: Kiosk mode and Raspberry Pi deployment setup
  - [x] 22.1 Create kiosk mode systemd service and Cage/Chromium configuration
  ...
  - [x] 22.2 Implement kiosk unlock mechanism
  ...
  - [x] 22.3 Bundle factory/precargado content with player
...
- [x] 23. Integration wiring and end-to-end flows
  - [x] 23.1 Wire player boot sequence (full startup flow)
  ...
  - [x] 23.2 Wire backend admin panel content preview
  ...
  - [x] 23.3 Wire multi-tenant pilot demonstration
  ...
  - [x] 23.4 Write integration tests for player ↔ backend communication
...
- [x] 24. Deployment scripts and documentation
  - [x] 24.1 Create Raspberry Pi provisioning script
  ...
  - [x] 24.2 Create backend local development setup script
    - docker-compose for PostgreSQL
    - Laravel migration + seeder runner
    - Create initial super-admin credentials
    - _Requirements: 13.2_

- [x] 25. Final checkpoint - Full system operational
